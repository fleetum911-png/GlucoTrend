...
#   2. Precision           7. Actual vs Predicted       12. Prediction CSV
#   3. Recall              8. Class Distribution        13. Random Forest Model
#   4. F1 Score            9. Feature Importance Chart  14. Model Parameters
#   5. Confusion Matrix    10. Random Forest Tree Visualization
# ================================================================
...
# ================================================================
OUTPUT_FOLDER = os.path.join(BASE_DIR, "outputs", "Random_Forest_Tree_M3_Outputs")
...
print("\n")
print("=" * 80)
print("              RANDOM FOREST - GLUCOSE RANGE CLASSIFICATION")
print("=" * 80)
...
# ================================================================
# 19. CREATE RANDOM FOREST CLASSIFIER
# ================================================================
...
plt.title("Actual vs Predicted Glucose Range - Random Forest")
...
# ================================================================
# 33. FEATURE NAMES AFTER ENCODING
# ================================================================
feature_names = model.named_steps["preprocessor"].get_feature_names_out()

# ================================================================
# 34-35. FEATURE IMPORTANCE
# ================================================================
...
# ================================================================
# 36. RANDOM FOREST TREE VISUALIZATION (first tree in the forest)
# ================================================================
print("\n" + "=" * 80)
print("                RANDOM FOREST TREE VISUALIZATION")
print("=" * 80)
print("\nRendering the first tree in the forest (of", rf_classifier.n_estimators, "total)...")
...
plot_tree(
    ...
    precision=2,
    fontsize=8,
    max_depth=3  # forest trees run deep - cap the drawing depth for readability
)
plt.title("Random Forest - First Tree (depth-limited view)", fontsize=20)
plt.tight_layout()
tree_image_path = os.path.join(TREE_FOLDER, "random_forest_first_tree.png")
plt.savefig(tree_image_path, dpi=300, bbox_inches="tight")
plt.close()
print("\nTree diagram saved at:", tree_image_path)
...
# ================================================================
# 38. SAVE TRAINED MODEL
# ================================================================
with open(os.path.join(MODEL_FOLDER, "random_forest_model.pkl"), "wb") as file:
    pickle.dump(model, file)

# ================================================================
# 39. SAVE MODEL PARAMETERS
# ================================================================
parameters_df = pd.DataFrame({
    "Parameter": ["Algorithm", "Target", "N Estimators", "Criterion", "Maximum Depth",
                  "Minimum Samples Split", "Minimum Samples Leaf", "Max Features", "Random State"],
    "Value": ["Random Forest Classifier", target_column, random_forest.n_estimators,
              random_forest.criterion, random_forest.max_depth, random_forest.min_samples_split,
              random_forest.min_samples_leaf, random_forest.max_features, random_forest.random_state]
})
